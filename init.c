...
init(int *il1, int *il2, double *m, double *q, double *t, double *nm, 
	int *vbin1, int *vbin2, double *dvb, double *vstart, int *nvbin)
{
	...
	int ngr, i, j, i1, i2, n=128, nlg=1, nv2=0, mode=1,nbins=0;
	char a_char[80];
